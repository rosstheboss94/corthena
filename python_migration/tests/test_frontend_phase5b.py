...
from corthena.frontend.golden import compare_pngs
...
from corthena.frontend.visualization import Candle, LayerKind, Point, Rect, Sample
...
def test_python_capture_matches_go_phase5_matrix(
    ...
    completed = subprocess.run(
        (
            sys.executable,
            "-m",
            "corthena.frontend.phase5b_capture",
            "--output",
            str(capture),
            "--width",
            str(width),
