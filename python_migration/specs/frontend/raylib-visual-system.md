...
**Related:** [Frontend foundation](foundation.md), [Workspaces](workspaces.md), [Visualization](visualization.md), [Visualization quality](../quality-visualization.md), [Migration baseline](../migration-baseline.md)
...
The established Go workstation is the default design authority. Canonical PNG
files and adjacent JSON manifests under
`internal/app/workstation/testdata/*-golden/` are normative visual evidence.
Phase 1–9 JPEG files under `python_migration/screenshots/` are design references
