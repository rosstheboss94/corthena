...
**Related:** [Specification index](../README.md), [Concurrency and parallelism](concurrency-and-parallelism.md), [Technology stack](technology-stack.md), [System architecture](system-architecture.md), [API](api.md), [Python migration](../history/migration/python-migration.md)

This is the shared architecture pattern specification for Python/Cython routes.
The root/UI language cutover is complete; the same rules govern all subsequent
...
Relevant changes must pass the quality gates owned by
