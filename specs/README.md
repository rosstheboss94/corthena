...
| [python-migration.md](python-migration.md) | Completed Python root/UI cutover, planned package mapping, compatibility rules, and retained baseline policy |
| [migration-baseline.md](migration-baseline.md) | Accepted cutover ownership map and functional, replay, and visual evidence |
...
2. Read `contract.md` before every task; it owns Python authoring and
   agent-context rules.
3. Read `design-pattern.md` for every Python/Cython implementation route.
...
8. Inspect `screenshots/` only for visual-design or retained-baseline work.
