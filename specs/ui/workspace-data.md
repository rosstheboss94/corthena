...
The workspace loads snapshots and submits imports through typed
`UIClientProtocol` operations. Imports remain generation-safe and cancellable;
only an accepted response may atomically advance the catalog revision.
