...
- Verify with the owning verification skill plus visualization verification
  when render or table kernels change.
- Exclude: model engine, registry, inference scoring, and real backend work.
