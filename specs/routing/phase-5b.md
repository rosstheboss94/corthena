...
- Current implementation and evidence: the Python visualization, table,
  native-rendering, effects, and capture modules; `tests/test_ui_phase5b.py`;
  and `tests/goldens/phase5-golden/`.
...
- The reviewed manifest and exactly six retained lossless cutover PNGs under
  `tests/goldens/phase5-golden/` are the regression authority.
...
- All six manifest cases pass decoded-RGBA comparison against retained cutover PNGs
...
Phase 5b is complete. Future visual changes must preserve or deliberately
revise the retained baseline, configured gates, and audit evidence.
