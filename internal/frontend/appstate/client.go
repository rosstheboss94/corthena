...
type FrontendClient interface {
	...
	ModelsWorkspace(context.Context, ModelsWorkspaceQuery) (ModelsWorkspaceMessage, error)
	AssignModelAlias(context.Context, AliasAssignmentCommand) (AliasAssignedMessage, error)
	InferenceWorkspace(context.Context, InferenceWorkspaceQuery) (InferenceWorkspaceMessage, error)
	ExportInference(context.Context, ExportInferenceCommand) (InferenceExportMessage, error)
