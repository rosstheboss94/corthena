...
Corthena is a Windows-first trading research workstation implemented as a
typed Python/Cython modular monolith.
...
```powershell
cd C:\Users\torra\Desktop\Projects\corthena
```
...
Launch the simulator-backed workstation:
...
This is a specification-first Python project. Read [`AGENTS.md`](AGENTS.md) and the
...
The Python/Cython implementation is the primary Corthena codebase. Historical
migration deviations are recorded under `specs/missing/`.
