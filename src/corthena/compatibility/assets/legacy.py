...
from corthena.ui import assets as packaged_assets


def legacy_asset_root() -> Path:
    """Locate the package-owned assets retained for compatibility evidence."""
    return Path(packaged_assets.__file__).resolve().parent
