"""Validated, package-owned UI assets."""
        ...
        try:
            ...
            for relative, signature in required:
                ...
                if not content.startswith(signature):
                    raise AssetValidationError(f"invalid bundled UI asset: {relative}")
...
__all__ = ["AssetLease", "AssetValidationError", "UIAssets"]
